    ...
    <section id="summary" className="py-20 px-6">
      <div className="mx-auto max-w-3xl">
        <ScrollReveal>
          ...
          <p className="mt-6 text-lg text-dark-text-muted leading-relaxed">
        ...
        <ScrollReveal delay={100}>
          <ul className="mt-8 space-y-4">
            {highlights.map((key) => (
              <li key={key} className="flex gap-3 text-dark-text-muted">
        ...
        <ScrollReveal delay={200}>
          <h3 className="mt-12 text-lg font-semibold text-dark-text">
